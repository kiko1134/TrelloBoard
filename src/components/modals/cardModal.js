  ...
  function addLabel(labelName) {
    if (labelName) {
      if (!appState.boards[appState.current_board].columns[columnIndex].cards[cardIndex].labels.includes(labelName)) {
        ...
        document.getElementById("inputLabel").firstChild.value = '';
        document.getElementById("inputLabel").firstChild.focus();
      }
    }
  }
            ...
            <div className='actions'>
              ...
              <div className='action'>
                ...
                <div className='timeDiv'>
                  <p>Created:</p>
                  <p2 className='time'>{new Date(card.created).toLocaleString()}</p2>
                </div>
              </div>
              <div className='action'>
                <i className='far fa-clock'> </i>
                <div className='timeDiv'>
                  <p>Updated:</p>
                  <p2 className='time'>{new Date(card.updated).toLocaleString()}</p2>
                </div>
              </div>
              <h4>Actions</h4>
              <div className='action'>
